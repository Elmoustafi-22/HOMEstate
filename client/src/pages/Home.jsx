        ...
        <div>
            {/* top */}
              <div className='flex flex-col gap-6 p-28  px-3 max-w-6xl
                mx-auto'>
                <h1 className='text-teal-700 font-bold text-3xl
                  lg:text-6xl'>
                        ...
                        <div className=''>    
                            <div className='my-3 '>
                                <div>
                                    ...
                                    text-teal-600'>Recent offers</h2>
                    ...
                    rentListings && rentListings.length > 0 && (
                        <div className=''>
                            <div className='my-3 '>
                                <div>
                                    <h2 className='text-2xl font-semibold
                                    text-teal-600'>Recent places for rent</h2>
                                    <Link className='text-sm text-blue-800 hover:underline'
                                    to={'/search?type=rent'}>
                    ...
                    saleListings && saleListings.length > 0 && (
                        <div className=''> 
                            <div className='my-3 '>
                                <div>
                                    <h2 className='text-2xl font-semibold
                                    text-teal-600'>Recent places for sale</h2>
                                    <Link className='text-sm text-blue-800 hover:underline'
                                    to={'/search?type=sale'}>
